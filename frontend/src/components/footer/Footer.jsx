        ...
        <div className="footer-content">
            <div className="footer-content-left">
                ...
                <div className="footer-social-icons">
                    <a href="https://github.com/Harsh-Piplodiya" ><img src={assets.github_icon} alt="github" /></a>
                    <a href="https://www.linkedin.com/in/harsh-piplodiya-24266a234/"><img src={assets.linkedin_icon} alt="linkedin" /></a>
                    <a href="https://twitter.com/harshp2910"><img src={assets.twitter_icon} alt="twitter" /></a>
                </div>
            </div>
